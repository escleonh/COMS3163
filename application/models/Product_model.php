...
Class Product_model extends CI_Model {
    public function getAllProducts(){
      ...
      public function getSearchedProduct($product){
        // echo "select ItemID, ItemName, ItemDescription, ItemPrice from Final_All_Items where ItemName='$product'";
        $query = $this->db->query("select ItemID, ItemName, ItemDescription, ItemPrice from Final_All_Items where ItemDescription like'%$product%'");
      ...
      public function storeOrder($OrderID, $UserID, $OrderTotal, $OrderDate, $ItemOrdered, $ItemOrderedName, $ItemOrderedDescription, $ItemOrderedPrice){
        $qstr = "insert into Final_Orders values($OrderID, $UserID, $OrderTotal, '$OrderDate', $ItemOrdered, '$ItemOrderedName', '$ItemOrderedDescription', $ItemOrderedPrice)";
        echo $qstr;
